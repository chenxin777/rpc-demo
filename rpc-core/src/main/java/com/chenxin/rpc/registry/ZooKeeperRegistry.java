...
public class ZooKeeperRegistry implements Registry{
     ...
     * @return org.apache.curator.x.discovery.ServiceInstance<com.chenxin.rpc.model.ServiceMetaInfo>
     */
    public ServiceInstance<ServiceMetaInfo> buildServiceInstance(ServiceMetaInfo serviceMetaInfo) {
        String serviceAddress = serviceMetaInfo.getServiceHost() + ":" + serviceMetaInfo.getServiceHost();
        try {
